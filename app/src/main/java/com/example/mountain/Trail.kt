...
class Trail(
    ...
    companion object {
        ...
        val hardTrails = arrayOf(
            Trail(0, "HARD1", "Discover the beauty of mountain landscapes.", arrayOf("Mountain Peak", "Valley View"), thumbnail = "https://i.pinimg.com/originals/1d/e4/ab/1de4ab9701560f33903a119b1609003d.jpg"),
            Trail(1, "HARD2", "Explore serene forests with diverse wildlife.", arrayOf("Old Oak Tree", "Clearing"), thumbnail = "https://www.pittsburghmagazine.com/content/uploads/2020/03/cb-cook-forest-trail1.jpg"),
            Trail(2, "HARD3", "Enjoy a peaceful stroll along the lake shore.", arrayOf("Lakeside View", "Docks"), thumbnail = "https://leitrimtourism.com/wp-content/uploads/2020/07/walking-keeldra-lake-01.jpg"),
            Trail(3, "HARD4", "Challenge yourself with a run along mountain ridges.", arrayOf("Scenic Ridge", "Narrow Path"), thumbnail = "https://winddrinkers.org/wp-content/uploads/2014/08/baldy_mountain_3-705x529.jpg"),
            Trail(4, "Waterfall Trail", "Experience the power and beauty of waterfalls.", arrayOf("Waterfall Cascade", "Rocky Path"), thumbnail = "https://www.example.com/image5.jpg"),
            Trail(5, "Sunset Climb", "Climb to the top for breathtaking sunset views.", arrayOf("Sunset Peak", "Twilight Ridge"), thumbnail = "https://www.example.com/image6.jpg"),
            Trail(6, "Canyon Exploration", "Discover hidden canyons and winding paths.", arrayOf("Canyon Walls", "Narrow Gorge"), thumbnail = "https://www.example.com/image7.jpg"),
            Trail(7, "Desert Trek", "Traverse vast deserts and sandy dunes.", arrayOf("Desert Oasis", "Endless Horizon"), thumbnail = "https://www.example.com/image8.jpg"),
